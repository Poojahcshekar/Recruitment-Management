...
public class StudentForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(140, 153, 54));
        ...
        ise.setFont(new java.awt.Font("Ubuntu", 1, 18)); // NOI18N
        ise.setText("ISE");
        ...
        cse.setFont(new java.awt.Font("Ubuntu", 1, 18)); // NOI18N
        cse.setText("CSE");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(cse, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(ise, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(sem, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap(181, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(usn, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(name, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(jButton5)
                                    .addComponent(grade, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            if(ise.isSelected())
            {
                department=ise.getText();
            }
            pstm.setString(3,department);
            pstm.setInt(4,Integer.parseInt(sem.getText()));
            
            String grd;
            grd=grade.getSelectedItem().toString();
            pstm.setString(5,grd);
            pstm.executeUpdate();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/jitstud", "root", "root");
            String sql="select * from students where usno=?";
            PreparedStatement pstm=con.prepareStatement(sql);
            pstm.setString(1, usn.getText());
            ...
            if(rs.next())
            {
                ...
                if(grd.equals("C"))
                grade.setSelectedIndex(2);
                if(grd.equals("D"))
                grade.setSelectedIndex(3);
                if(grd.equals("E"))
                grade.setSelectedIndex(4);
                if(grd.equals("F"))
                grade.setSelectedIndex(5);
               // grade.addItem(grd);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try
        {
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/jitstud", "root", "root");
            String sql="delete from students where usno = ?";
            PreparedStatement pstm=con.prepareStatement(sql);
            pstm.setString(1, usn.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try
        {
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/jitstud", "root", "root");
            String sql="update students set name=?, department=?, sem=?, grade=? where usno=?";
            PreparedStatement pstm=con.prepareStatement(sql);
            pstm.setString(5, usn.getText());
            ...
            pstm.setInt(3,Integer.parseInt(sem.getText()));
            
            String grd;
            grd=grade.getSelectedItem().toString();
            pstm.setString(4,grd);
            pstm.executeUpdate();
